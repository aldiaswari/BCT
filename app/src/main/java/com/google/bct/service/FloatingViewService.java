...
public class FloatingViewService extends Service {
    ...
    public void onCreate() {
        ...
        mFloatingView = LayoutInflater.from(this).inflate(R.layout.activity_floating, null);
        ...
        playButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (pref.getBoolean("lgjk", false)) {
                    Intent service3 = new Intent(FloatingViewService.this, Ping.class);
                    {
                ...
                Intent service2 = new Intent(FloatingViewService.this, LocationService.class);
                {
                ...
                pref.edit().putBoolean("mock", true).apply();
                //  startService(new Intent(FloatingViewService.this, LocationService.class));
            }
        });
...
*/
        ...
        ImageView prevButton = (ImageView) mFloatingView.findViewById(R.id.stop_btn);
        prevButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //           Toast.makeText(FloatingViewService.this, "Playing previous song.", Toast.LENGTH_LONG).show();
                if (pref.getBoolean("lgjk", false)) {
                    Intent service2 = new Intent(FloatingViewService.this, Ping.class);
                    {
                ...
                Intent service1 = new Intent(FloatingViewService.this, LocationService.class);
                {
                ...
                //     stopService(new Intent(FloatingViewService.this, LocationService.class));
            }
        });
