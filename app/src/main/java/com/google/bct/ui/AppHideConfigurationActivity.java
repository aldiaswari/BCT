...
import com.google.bct.adapter.CheckBoxAdapter;
...
import static com.google.bct.ui.HideActivity.pref;
...
public class AppHideConfigurationActivity  extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(AppHideConfigurationActivity.this,HideActivity.class);
